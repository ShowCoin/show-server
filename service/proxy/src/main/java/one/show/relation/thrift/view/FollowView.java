...
public class FollowView implements org.apache.thrift.TBase<FollowView, FollowView._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FollowView");
  ...
  static {
    schemes.put(StandardScheme.class, new FollowViewStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FollowViewTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FollowView.class, metaDataMap);
  }
   ...
   */
  public FollowView(FollowView other) {
  ...
  public FollowView deepCopy() {
    return new FollowView(this);
  }
  ...
  public FollowView setUid(long uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
  ...
  public FollowView setFid(long fid) {
    this.fid = fid;
    setFidIsSet(true);
    return this;
  }
  ...
  public FollowView setTime(int time) {
    this.time = time;
    setTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FollowView)
      return this.equals((FollowView)that);
    return false;
  }

  public boolean equals(FollowView that) {
    if (that == null)
      return false;
  ...
  public int compareTo(FollowView other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    FollowView typedOther = (FollowView)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FollowView(");
    boolean first = true;
  ...
  private static class FollowViewStandardSchemeFactory implements SchemeFactory {
    public FollowViewStandardScheme getScheme() {
      return new FollowViewStandardScheme();
    }
  }

  private static class FollowViewStandardScheme extends StandardScheme<FollowView> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FollowView struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FollowView struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FollowViewTupleSchemeFactory implements SchemeFactory {
    public FollowViewTupleScheme getScheme() {
      return new FollowViewTupleScheme();
    }
  }

  private static class FollowViewTupleScheme extends TupleScheme<FollowView> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FollowView struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FollowView struct) throws org.apache.thrift.TException {
